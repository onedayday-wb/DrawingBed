...
<footer id="rin-footer">
    <div>©2020-2021 Blue. | Made with love by Blue. | BG: <a href="https://cdn.jsdelivr.net/gh/onedayday-wb/DrawingBed@main/">
	   <img class="badge" src="https://data.jsdelivr.com/v1/package/gh/onedayday-wb/DrawingBed/badge"></a>
		</div>
</footer>
...
function uploadimg(file){
      ...
      var picurl="https://cdn.jsdelivr.net/gh/onedayday-wb/DrawingBed@main/"+nameofimg;
    var settings = {
    "url": "https://api.github.com/repos/onedayday-wb/DrawingBed/contents/"+nameofimg,
    "method": "PUT",
    "timeout": 0,
    "headers": {
        "Authorization": "Bearer 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",
